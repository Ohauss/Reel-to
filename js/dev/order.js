...
new SimpleBar(document.querySelector(".info-order__items"));
const list = document.querySelector(".info-order__items");
...
<div class="order-product__inner">
...
function renderTotals() {
  const amount = cartStore.total();
  const delivery = amount > 500 ? 0 : 15;
